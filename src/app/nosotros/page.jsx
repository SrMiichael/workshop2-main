        ...
        <main className="flex flex-col gap-12 row-start-2 items-center sm:items-start">
          ...
          <div className="text-center sm:text-left animate-fadeIn">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              ...
              enfocados en brindar la mejor experiencia para nuestros clientes.
              Trabajamos juntos para crear algo único, apoyando tanto la
              innovación como las tradiciones.
            </p>
          </div>
