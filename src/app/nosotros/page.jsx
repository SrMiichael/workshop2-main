  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        <div>
          <h1 className="text-2xl font-bold pb-5">Integrantes</h1></div>
      ...
      <main className="flex flex-col gap-12 row-start-2 items-center sm:items-start">
        ...
        <div className="text-center sm:text-left animate-fadeIn">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            Somos un equipo dedicado a proporcionar productos de calidad, enfocados en brindar la mejor experiencia para nuestros clientes.
            Trabajamos juntos para crear algo único, apoyando tanto la innovación como las tradiciones.
          </p>
        </div>

        {/* Sección de perfiles con sombra, bordes redondeados y animaciones */}
        <div className="w-full">
          <h2 className="text-3xl font-bold pb-5 text-gray-800">Colaboradores</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            <div className="border rounded-lg shadow-lg p-6 bg-white hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-2">
              ...
              />
              <Perfil nombre="Diego Navarro" email="diego.navarro2@utp.ac.pa" />
